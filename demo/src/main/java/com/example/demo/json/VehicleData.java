...
public class VehicleData {
	...
	public VehicleData(String id, String name, long parameter1, double parameter2, int parameter3, long parameter4,
			double parameter5, int parameter6, int parameter7) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "VehicleData [id=" + id + ", name=" + name + ", parameter1=" + parameter1 + ", parameter2=" + parameter2
