...
public class VehicleData {
	...
	public VehicleData(long parameter1, double parameter2, int parameter3, long parameter4, double parameter5,
	...
	public String toString() {
		return "VehicleData [id=" + id + ", parameter1=" + parameter1 + ", parameter2=" + parameter2 + ", parameter3="
				+ parameter3 + ", parameter4=" + parameter4 + ", parameter5=" + parameter5 + ", parameter6="
				+ parameter6 + ", parameter7=" + parameter7 + "]";
	}
